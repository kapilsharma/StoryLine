...
All creative content under `examples/` — character names, plot, notes and the *Zoey Nyxx* / *Thettana* setting — is **© Kapil Sharma (pen name Zoey Nyxx), all rights reserved**. It is included **for demonstration purposes only**. You may read it and use these files to try out the app, but you may **not** copy, adapt, redistribute or build upon the story content.
